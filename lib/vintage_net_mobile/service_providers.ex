defmodule VintageNetMobile.ServiceProviders do
  @moduledoc """
  ...
  defp error_message(provider_name) do
    [
      """
      The provider: "#{provider_name}" is not supported by VintageNetMobile. Please check your
  ...
  defp extra_service_providers() do
    Application.get_env(:vintage_net_mobile, :extra_service_providers, [])
  end
end
